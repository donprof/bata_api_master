<template>
    <span>
            ...
            <div class="card-header">
                <div class="row align-items-center justify-content-between">
                    <div class="col-6 col-sm-auto d-flex align-items-center pr-0">
                        <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0">Ofers.</h5>
                    </div>
                ...
                <table class="table table-sm mb-0 table-dashboard fs--1">
                    ...
                    <tbody id="purchases">
                        <tr v-for="dt in data" :key="dt.id" class="btn-reveal-trigger">
                            ...
                            <th class="align-middle">{{dt.blinker}}</th>
                            <th class="align-middle">{{dt.description}}</th>
                            <td class="align-middle">{{dt.image}}</td>
        ...
        <modal name="baseModal" classes="animated bounceInDown faster" :clickToClose="true" height="auto" :adaptive="true" :scrollable="true" :pivotY="0.2">
            <offersform :categorylist="categorylist" :base="variation" :state="state"></offersform>
        </modal>
...
export default {
    ...
    computed: {
        ...mapGetters({
            data: 'offers/getOffers',
            variation: 'offers/getVariation',
            categorylist: 'categories/getcategorylist',
        })
    },
    methods: {
        ...mapActions({
            fetchOfers: 'offers/fetchOfers',
            selectedVariation: 'offers/selectedVariation',
