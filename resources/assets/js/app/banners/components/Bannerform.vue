        ...
        <div class="modalbluepart mr-auto ml-auto">
            <div class="row">
                <div class="col-10 mt-2">
                    <h5 v-if="state == 1" class="text-white ml-3 mt-2">Edit Banner: {{base.name}}</h5>
                    <h5 v-else class="text-white ml-3 mt-2">New Banner.</h5>
                </div>
        ...
        <div class="modalwhitepart mr-auto ml-auto">
            <div class="row">
                <div class="col-md-12 mb-1">
                    <products-upload buss="offer-image-upload" :base="base" endpoint="/api/bannerimages"/>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...mapActions({
                updatOfers: 'banners/updatOfers',
                createOffer: 'banners/createOffer',
            }),
            closemodal: function () {
