<template>
	<div>
        <div class="bg-white p-3 h-100 text-center point">
            ...
            <span>
                <img v-if="base" class="img-thumbnail img-fluid rounded mb-3 shadow-sm" :src="base.imagelink+'offer/'+base.image" alt="" width="100">
                <img v-else class="img-thumbnail img-fluid rounded mb-3 shadow-sm" src="/assets/img/default/default.jpg" alt="" width="100">
            </span>
...
<script>
    import upload from '../mixins/uploadcsv'
    import Bus from '../bus'
