<template>
    <div class="mymodal">
        ...
        <div class="modalwhitepart mr-auto ml-auto">
            <template v-if="report.apislug == 's01' || report.apislug == 's02' || report.apislug == 's03' || report.apislug == 's05'">
                <div class="row">
                    <div class="col-md-12">
            ...
            <template v-if="report.apislug == 's04'">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group has-error has-danger">
                            <label> Items</label>
            ...
            <template v-if="report.apislug == 's02' || report.apislug == 's03'  || report.apislug == 's04'">
                <div class="row">
                    <div class="col-md-6">
...
<script>
    ...
    export default {
        ...
        methods:{
            ...mapActions({
                getSelectReport: 'inventoryreports/getSelectReport',
            }),
            datacolected(type){
                let data = {
