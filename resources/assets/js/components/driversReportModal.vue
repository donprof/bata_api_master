<template>
    <div class="mymodal">
        ...
        <div class="modalwhitepart mr-auto ml-auto">
            ...
            <template v-if="report.apislug == 'd01'">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group has-error has-danger">
                            <label> Category</label>
                            <v-select label="value" :onChange="catogoriesCallback" :options="allCategories"></v-select>
                            <formerror v-if="errors.center" :error="errors.center[0]"></formerror>
                        </div>
                    </div>
                </div>
            </template>
            <template v-if="report.apislug == 'd02' || report.apislug == 'd03' ">
                <div class="row">
                    <div class="col-md-6">
