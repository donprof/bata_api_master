<template>
    <div class="mymodal">
        ...
        <div class="modalwhitepart mr-auto ml-auto">
            <template v-if="report.apislug == 'v01' || report.apislug == 'v04' || report.apislug == 'v05' || report.apislug == 'v07' || report.apislug == 'v06' || report.apislug == 'v08'">
                <div class="row">
                    <div class="col-md-12">
            ...
            <template v-if="report.apislug == 'v02'">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group has-error has-danger">
                            <label> Make</label>
                            <v-select label="value" :onChange="makesCallback" :options="makes"></v-select>
                            <formerror v-if="errors.center" :error="errors.center[0]"></formerror>
                        </div>
                    </div>
                </div>
            ...
            <template v-if="report.apislug == 'v07'">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group has-error has-danger">
                            <label> Bases</label>
                            <v-select label="value" :onChange="baseCallback" :options="bases"></v-select>
                            <formerror v-if="errors.center" :error="errors.center[0]"></formerror>
                        </div>
                    </div>
                </div>
