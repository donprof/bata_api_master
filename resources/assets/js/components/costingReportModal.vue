<template>
    <div class="mymodal">
        ...
        <div class="modalwhitepart mr-auto ml-auto">
            <template v-if="report.apislug == 'c01' || report.apislug == 'c02' || report.apislug == 'c03' || report.apislug == 'c04' || report.apislug == 'c05' || report.apislug == 'c06' || report.apislug == 'c07'">
                <div class="row">
                    <div class="col-md-12">
            ...
            <template v-if="report.apislug == 'c08'">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group has-error has-danger">
...
<script>
    ...
    export default {
        ...
        methods:{
            ...mapActions({
                getSelectReport: 'costingreports/getSelectReport',
            }),
            datacolected(type){
                let data = {
